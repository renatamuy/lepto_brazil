##############################################################
# Downloading month rainfall in a temporal series
...
part1<-"http://iridl.ldeo.columbia.edu/SOURCES/.NOAA/.NCEP/.CPC/.Merged_Analysis/.monthly/.latest/.ver2/.prcp_est/X"
part2<-"RANGEEDGES/Y"
...
for(n in 1:nrow(files_list))
{
  ...
  colnames(tab) <- c("Pluv","year","month","CD_GEOCMU")
...
write.csv(dados, "SP_zonal__ver2_prcp_est_2018_10_D12.csv", row.names= FALSE)

save.image(file="SP_zonal__ver2_prcp_est_2018_10_D12.RData") 
...
hist(dados$Pluv)
#setwd("D:/Coworks/Leptospirose/zonal_covariates/NOAA_sp")
load("SP_zonal__ver2_prcp_est_2018_10_D12.RData.RData")
